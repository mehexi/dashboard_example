...
const NewUser = ({ allUser }) => {
  return (
    <Card className="col-span-6 lg:col-span-2 h-40 bg-primary-foreground flex justify-between items-center">
      ...
      <CardContent className="p-6 flex items-center gap-3 pl-0">
        <div className="flex flex-col items-end text-end">
          <span className="px-2 py-1 border rounded-full text-xs text-green-500 border-green-500">
            newset user
          </span>
